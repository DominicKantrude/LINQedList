...
namespace linqGroupBy
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IEnumerable<string> LFruits = fruits.Where(fruit => fruit[0].ToString() == "L");
            ...
            List<int> numbers2 = new List<int>()
{
    15, 8, 21, 24, 32, 13, 30, 12, 7, 54, 48, 4, 49, 96
            ...
            List<int> numbersDescend = numbers.OrderBy(n => n).ToList();
            ...
            foreach (var number in numbersDescend)
            {
                Console.WriteLine($"{number}");
            }
            /************************************************************* */
            ...
            List<double> prices = new List<double>()
{
    879.45, 9442.85, 2454.63, 45.65, 2340.29, 34.03, 4786.45, 745.31, 21.76
            ...
            Console.WriteLine($"Most expensive purchase: {purchases.Max()}");
            ...
            List<int> wheresSquaredo = new List<int>()
{
    66, 12, 8, 27, 82, 34, 7, 50, 19, 46, 81, 23, 30, 4, 68, 14
            ...
            foreach (var number in untilPerfectSquareFound)
            {
                Console.WriteLine($"{number}");
            }
            /************************************************************* */
...
*/
            ...
            */
            List<ReportItem> millionaireReport = customers2.Where(customer => customer.Balance > 999999)
